...
def build_execution_finished_event(
    *,
    actor: str,
    user_turn_hash: str | None,
    text: str,
...
def build_review_request_event(
    *,
    actor: str,
    user_turn_hash: str | None,
    review_kind: str,
...
def build_review_decision_event(
    *,
    actor: str,
    user_turn_hash: str | None,
    review_kind: str,
...
def has_conversation_event(
    ...
    *,
    ...
    artifacts = dict(ensure_conversation_state(state).get("artifacts") or {})
    for event in list(artifacts.get("conversation_events") or []):
        if event.get("type") != event_type:
            continue
        if user_turn_hash is not None and event.get("user_turn_hash") != user_turn_hash:
            continue
